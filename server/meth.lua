...
RegisterServerEvent('DGX-DRUGS:pickedUpHydrochloricAcid', function()
	local src = source
...
RegisterServerEvent('DGX-DRUGS:pickedUpSodiumHydroxide', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:pickedUpSulfuricAcid', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:processChemicals', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:processTempUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:processTempDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:processMeth', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:processFailUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DGX-DRUGS:processFailDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
